    ...
    var $           = 	require('jquery'),
        ...
        Ciphers = Backbone.Model.extend({
            ...
            getAttributeByName: function( attr ){
            	//RETURN A COPY OF EACH ATTRIBUTE
            ...
            use: {
            	...
            	vegenere: function(opts){
            		 var string = opts.text.replace(/[^A-Za-z]+/gi, '').toLowerCase(),
            		    ...
            		    that.utils.eachCharacter(string, 1, function(i, char){
            		        var char_pos = jQuery.inArray(char,alpha),
